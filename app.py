...
with tabs[-1]:
    ...
    # Direct link to the dashboard.html file on GitHub
    # Using raw.githubusercontent.com (may have CORS issues but worth trying)
    ...
    <div style="text-align: center; margin-top: 20px; color: #888;">
        ...
        <ul style="text-align: left; display: inline-block;">
            <li>Click the button above to open the 3D viewer in a new tab</li>
            <li>Use the dropdown in the viewer sidebar to switch between buildings</li>
            <li>Left click + drag to rotate | Right click + drag to pan | Scroll to zoom</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
# =====================================================
